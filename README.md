...
The course develops the application incrementally while explaining the Windows application model, Visual Studio workflow, message handling, controls, resources, application state, file I/O, debugging, and executable construction.
